...
% supervisor(s)Zürich
\advisor{Prof. Michele Allegra}{University of Padua} % (mandatory)
...
\otheradvisor[Co-Supervisor]{Prof. Duccio Fanelli}{University of Florence}
...
\begin{document}
   ...
   %Do not put abstact and sommario
