...
However we changed the setup by \textbf{removing the input current} and setting a randomly uniform state $\left( V_i\left( 0 \right), w_i\left( 0 \right) \right) \in \left[-1, 1  \right]^2$ for each node $i$.
