...
\begin{enumerate}
    ...
    \item $\mathcal{A} = C(\overline{D}) = \left\{ f: \overline{D} \to \mathbb{R} \mathrel{\Big|} f \text{ is continuous on the closure of } D \right\}$.
\end{enumerate}
\end{assumption}
