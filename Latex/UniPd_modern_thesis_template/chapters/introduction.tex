...
The manuscript is structured as follows: in Chapter 1 we introduced the foundational neuroscientific ionic models that served as a basis for subsequent analyses. In Chapter 2 we provided a comprehensive overview of the SciML framework. In Chapter 3, we applied the techniques developed in the previous chapter to the emulation of neuroscientific systems using both simulated and real data. Finally, in Chapter 4 we focused on a highly versatile mathematical framework with applications ranging from morphogenesis to disease modeling: reaction-diffusion equations, originally formalized by Alan Turing in 1952 \cite{turing1952chemical}.