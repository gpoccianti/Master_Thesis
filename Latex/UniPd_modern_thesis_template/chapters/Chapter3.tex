...
\begin{figure}[htbp]
    \centering
    % Prima sottofigura: Schema della rete (ora a sinistra)
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
    ...
    \end{subfigure}
    \hfill
    % Seconda sottofigura: Grafico dei picchi (ora a destra)
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
...
These results are strengthened and summarized in the violin plots figure \ref{fig:fno_scaling_error}, for the distribution of $\log(MSE)$, as network size and type vary. To gain statistical relevance we aggregated data for the three different seed employed ($S=0,42,100$).
\newline
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{img/FH_model/error_FNO_scalingN_v2.png}
