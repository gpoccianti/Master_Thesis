...
Studying the brain is a very difficult task.
%Dire perché
The field of computational neuroscience has emerged as an interdisciplinary science that employs advanced mathematical models and simulation tools to understand the brain’s dynamics. 
 As in many other branches of complex systems a whole system (brain) analysis with single unit (neuron) resolution is impossible at present. This is why we often rely on coarse-grained mathematical descriptions, which may be validated by empirical data.
 %Spiegare che cos'è un modello coarse-grained
 However, single-neuron ionic models are still essential, both for a conceptual understanding of microscopic mechanisms and for the bottom-up derivation of higher-level models. 
 %Spiegare meglio bottom-up derivation
 %Rendere tutto il paragrafo più chiaro.
\newline
